export function autoMatch(transactie, lasten, periode) {
  ...
  // Lasten met een omschrijving_patroon worden ook uitgesloten: een last met een expliciet
  // patroon moet alléén op dat patroon matchen, nooit blind op bedrag — anders matcht een
  // ongerelateerde transactie met hetzelfde bedrag (bv. "Zakgeld Joey") toch.
  const bedragMatches = lasten.filter(last =>
    !last.iban_tegenrekening &&
    !last.omschrijving_patroon &&
