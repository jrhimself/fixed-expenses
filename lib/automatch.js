export function autoMatch(transactie, lasten, periode) {
  ...
  // Naam-match: alleen als last geen IBAN en geen omschrijving_patroon heeft
  for (const last of lasten) {
    if (!last.iban_tegenrekening && !last.omschrijving_patroon && last.naam && transactie.omschrijving) {
